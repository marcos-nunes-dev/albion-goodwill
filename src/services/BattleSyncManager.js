...
class BattleSyncManager {
     ...
     * @returns {Promise<{guildName: string}|null>}
     */
     ...
     * @param {Object} guildSettings Discord guild settings
        ...
        try {
            ...
            await prisma.battleRegistration.create({
                data: {
                    ...
                    kills: ourKills,
                    isVictory,
                    battleUrl: `https://albionbattles.com/battles/${battle.albionId}`
                }
            });
        ...
        try {
            ...
            for (const guildSettings of guildsToSync) {
                try {
                    ...
                    if (!guildInfo) {
                        logger.warn(`No guild info found for ID: ${guildSettings.albionGuildId}`);
                        continue;
                    }
