...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .setDescription(
      "Update roles of members based on their main class in Albion Online"
    )
    .addRoleOption((option) =>
      option
        .setName("role")
  ...
  new SlashCommandBuilder()
    .setName("registerhim")
    .setDescription(
      "Register an Albion Online character for another user (Admin only)"
    )
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
    .addUserOption((option) =>
      option
  ...
  new SlashCommandBuilder()
    .setName("pingpvp")
    .setDescription(
      "Creates a PVP event - use the builder https://albion-goodwill-web.vercel.app/ping-composition"
    )
    .addRoleOption((option) =>
  ...
  new SlashCommandBuilder()
    .setName("apply")
    .setDescription(
      "Register and check weapon statistics for your Albion Online character"
    )
    .addStringOption((option) =>
      option
        .setName("region")
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option
        .setName("battlelog_webhook")
        .setDescription(
          "Discord webhook URL for battle logs (create in channel settings)"
        )
        .setRequired(false)
    )
    .addChannelOption((option) =>
      option
        .setName("battlelog_channel")
  ...
  new SlashCommandBuilder()
    .setName("attendance")
    .setDescription(
      "Show attendance statistics for the guild or a specific user"
    )
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
    .addAttachmentOption((option) =>
      option
  ...
  new SlashCommandBuilder()
    ...
    .setDescription(
      "Identify members with low attendance based on a threshold or guild average"
    )
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
    .addAttachmentOption((option) =>
      option
  ...
  new SlashCommandBuilder()
    .setName("bulkrole")
    .setDescription("Add or remove a role from multiple users or roles")
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
    .addStringOption((option) =>
      option
        .setName("action")
